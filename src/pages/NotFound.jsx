      ...
      >
        ...
        <div className="grid h-[100vh] place-items-center px-6 py-10 lg:px-8">
          <div className="text-center">
            <p className="text-9xl font-semibold text-slate-900 dark:text-white overflow-hidden font-alfaSlabOne tracking-widest">
              404
            </p>
            <h1 className="py-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl overflow-hidden">
              Page not found
            </h1>
            <p className="mt-6 text-base leading-7 text-slate-600 dark:text-slate-300 overflow-hidden">
              Sorry, we couldn&apos;t find the page you&apos;re looking for.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6 overflow-hidden">
              <a
                href="/"
                className="rounded-md bg-cyan-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 tracking-widest"
              >
                Go back home
              </a>
              <a
                href="/contact"
                className="text-sm font-semibold text-slate-900 dark:text-white overflow-hidden"
              >
                <span className="text-base font-bold tracking-wide hover:text-cyan-600 dark:hover:text-cyan-400 overflow-hidden">
                  Contact Support
                </span>
              </a>
            </div>
